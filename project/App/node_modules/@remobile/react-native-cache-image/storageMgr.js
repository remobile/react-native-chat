...
const TABLE_CACHE_ID = "rct_cache_id";
const TABLE_CACHE_IMAGE = "rct_cache_image";
const TABLE_CACHE_STORAGE = "rct_cache_storage";
const CACHE_IMAGE_DIR = 'cacheimages';
const CACHE_IMAGE_SIZE = 1024*1024*500;
